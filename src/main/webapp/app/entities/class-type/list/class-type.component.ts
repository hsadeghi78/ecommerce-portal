...
import { EntityArrayResponseType, ClassTypeService } from '../service/class-type.service';
...
export class ClassTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IClassType): number => this.classTypeService.getClassTypeIdentifier(item);
