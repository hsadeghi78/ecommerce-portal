...
describe('ClassType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'class-type', component: ClassTypeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.classTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to classTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getClassTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getClassTypeIdentifier).toHaveBeenCalledWith(entity);
