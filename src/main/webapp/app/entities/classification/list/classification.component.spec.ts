...
describe('Classification Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'classification', component: ClassificationComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to classificationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getClassificationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getClassificationIdentifier).toHaveBeenCalledWith(entity);
