...
describe('UserFavorite Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'user-favorite', component: UserFavoriteComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userFavorites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to userFavoriteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUserFavoriteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUserFavoriteIdentifier).toHaveBeenCalledWith(entity);
