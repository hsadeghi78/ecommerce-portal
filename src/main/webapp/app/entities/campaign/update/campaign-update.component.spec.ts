...
describe('Campaign Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]), CampaignUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const products: IProduct[] = [{ id: 3066 }];
      campaign.products = products;

      const productCollection: IProduct[] = [{ id: 31849 }];
    ...
    it('Should update editForm', () => {
      const campaign: ICampaign = { id: 456 };
      const products: IProduct = { id: 29578 };
      campaign.products = [products];
