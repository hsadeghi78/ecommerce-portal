...
type ContactFormGroupContent = {
  ...
  typeClassId: FormControl<IContact['typeClassId']>;
  prefix: FormControl<IContact['prefix']>;
  description: FormControl<IContact['description']>;
  party: FormControl<IContact['party']>;
};
...
export class ContactFormService {
  createContactFormGroup(contact: ContactFormGroupInput = { id: null }): ContactFormGroup {
    ...
    return new FormGroup<ContactFormGroupContent>({
      ...
      typeClassId: new FormControl(contactRawValue.typeClassId, {
        validators: [Validators.required],
      }),
      prefix: new FormControl(contactRawValue.prefix, {
        validators: [Validators.maxLength(7)],
      }),
      description: new FormControl(contactRawValue.description, {
        validators: [Validators.maxLength(500)],
      }),
      party: new FormControl(contactRawValue.party),
    });
  }
