...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../user-comment.test-samples';

import { UserCommentService } from './user-comment.service';

const requireRestSample: IUserComment = {
...
describe('UserComment Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a UserComment', () => {
      const userComment = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(userComment).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a UserComment', () => {
      const userComment = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(userComment).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addUserCommentToCollectionIfMissing', () => {
      it('should add a UserComment to an empty array', () => {
        const userComment: IUserComment = sampleWithRequiredData;
      ...
      it("should add a UserComment to an array that doesn't contain it", () => {
        const userComment: IUserComment = sampleWithRequiredData;
        const userCommentCollection: IUserComment[] = [sampleWithPartialData];
        expectedResult = service.addUserCommentToCollectionIfMissing(userCommentCollection, userComment);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(userComment);
      });
      ...
      it('should add only unique UserComment to an array', () => {
        const userCommentArray: IUserComment[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const userCommentCollection: IUserComment[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const userComment: IUserComment = sampleWithRequiredData;
        const userComment2: IUserComment = sampleWithPartialData;
    ...
    describe('compareUserComment', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareUserComment(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareUserComment(entity1, entity2);
        const compareResult2 = service.compareUserComment(entity2, entity1);
