...
/**
 * A DTO for the {@link com.hs.ec.portal.domain.Product} entity.
 */
@Schema(description = "4 field fixed and Party, prices, items\n@author Hossein Sadeghi (hsadeghi78@gmail.com)")
...
public class ProductDTO implements Serializable {
    ...
    private Set<FileDocumentDTO> documents = new HashSet<>();
    ...
    public Set<FileDocumentDTO> getDocuments() {
        return documents;
    }

    public void setDocuments(Set<FileDocumentDTO> documents) {
