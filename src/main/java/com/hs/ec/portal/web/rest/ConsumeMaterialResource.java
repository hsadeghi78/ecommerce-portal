...
/**
 * REST controller for managing {@link com.hs.ec.portal.domain.ConsumeMaterial}.
 */
@RestController
@RequestMapping("/api/consume-materials")
public class ConsumeMaterialResource {
    ...
    public ConsumeMaterialResource(ConsumeMaterialService consumeMaterialService, ConsumeMaterialRepository consumeMaterialRepository) {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<ConsumeMaterialDTO>> createConsumeMaterial(@Valid @RequestBody ConsumeMaterialDTO consumeMaterialDTO)
        ...
        return consumeMaterialService
            .save(consumeMaterialDTO)
            .map(result -> {
                try {
     ...
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<ConsumeMaterialDTO>> updateConsumeMaterial(
    ...
    public Mono<ResponseEntity<ConsumeMaterialDTO>> partialUpdateConsumeMaterial(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        return consumeMaterialRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<ConsumeMaterialDTO> result = consumeMaterialService.partialUpdate(consumeMaterialDTO);
    ...
    public Mono<ResponseEntity<List<ConsumeMaterialDTO>>> getAllConsumeMaterials(
        ConsumeMaterialCriteria criteria,
        ...
        return consumeMaterialService
            ...
            .zipWith(consumeMaterialService.findByCriteria(criteria, pageable).collectList())
     ...
     */
    @GetMapping("/count")
    public Mono<ResponseEntity<Long>> countConsumeMaterials(ConsumeMaterialCriteria criteria) {
        log.debug("REST request to count ConsumeMaterials by criteria: {}", criteria);
        return consumeMaterialService.countByCriteria(criteria).map(count -> ResponseEntity.status(HttpStatus.OK).body(count));
    }
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<ConsumeMaterialDTO>> getConsumeMaterial(@PathVariable Long id) {
        log.debug("REST request to get ConsumeMaterial : {}", id);
        Mono<ConsumeMaterialDTO> consumeMaterialDTO = consumeMaterialService.findOne(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteConsumeMaterial(@PathVariable Long id) {
