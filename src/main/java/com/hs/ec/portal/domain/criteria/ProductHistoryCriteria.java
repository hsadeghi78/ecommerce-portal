...
/**
 * Criteria class for the {@link com.hs.ec.portal.domain.ProductHistory} entity. This class is used
 * in {@link com.hs.ec.portal.web.rest.ProductHistoryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-histories?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductHistoryCriteria implements Serializable, Criteria {
    ...
    public ProductHistoryCriteria() {}

    public ProductHistoryCriteria(ProductHistoryCriteria other) {
    ...
    @Override
    public ProductHistoryCriteria copy() {
        return new ProductHistoryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductHistoryCriteria that = (ProductHistoryCriteria) o;
        return (
