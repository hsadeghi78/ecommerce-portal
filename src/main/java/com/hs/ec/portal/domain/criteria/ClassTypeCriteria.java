...
/**
 * Criteria class for the {@link com.hs.ec.portal.domain.ClassType} entity. This class is used
 * in {@link com.hs.ec.portal.web.rest.ClassTypeResource} to receive all the possible filtering options from
...
public class ClassTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, typeCode, description, distinct);
    }
