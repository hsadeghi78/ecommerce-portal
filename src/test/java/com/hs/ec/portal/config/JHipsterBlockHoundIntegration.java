...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.hs.ec.portal.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.hs.ec.portal.security.DomainUserDetailsService", "createSpringSecurityUser");
